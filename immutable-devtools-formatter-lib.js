...
const immutableNameStyle = {
  style: "color: rgb(232,98,0); position: relative",
};
...
const inlineValuesStyle = {
  style: "color: #777; font-style: italic; position: relative",
};
...
function createFormatters(Immutable) {
  ...
  const SetFormatter = {
    ...
    hasBody,
    body(o) {
      return renderIterableBody(o, (value) => ["li", reference(value)], {
        sorted: true,
      });
    },
  };
...
let installed = false;
export function install(Immutable) {
